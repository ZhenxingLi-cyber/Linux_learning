  ...
  std::ostream & out)
{
  ...
  {
    out << "cpu_precentage: ";
    rosidl_generator_traits::value_to_yaml(msg.cpu_precentage, out);
    out << ", ";
  }

  // member: memory_precentage
  {
    out << "memory_precentage: ";
    rosidl_generator_traits::value_to_yaml(msg.memory_precentage, out);
    out << ", ";
  }
  ...
  {
    out << "net_send: ";
    rosidl_generator_traits::value_to_yaml(msg.net_send, out);
    out << ", ";
  }

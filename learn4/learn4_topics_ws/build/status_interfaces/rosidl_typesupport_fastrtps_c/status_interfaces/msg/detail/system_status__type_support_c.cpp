  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cpu_precentage
  {
    cdr << ros_message->cpu_precentage;
  }

  // Field name: memory_precentage
  {
    cdr << ros_message->memory_precentage;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name cpu_precentage
  {
    size_t item_size = sizeof(ros_message->cpu_precentage);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name memory_precentage
  {
    size_t item_size = sizeof(ros_message->memory_precentage);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name memory_total
  ...
  // field.name net_send
  {
    size_t item_size = sizeof(ros_message->net_send);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name net_recv

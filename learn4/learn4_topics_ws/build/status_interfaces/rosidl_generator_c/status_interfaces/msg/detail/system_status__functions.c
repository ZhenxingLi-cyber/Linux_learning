...
status_interfaces__msg__SystemStatus__are_equal(const status_interfaces__msg__SystemStatus * lhs, const status_interfaces__msg__SystemStatus * rhs)
{
  ...
  // cpu_precentage
  if (lhs->cpu_precentage != rhs->cpu_precentage) {
    return false;
  }
  // memory_precentage
  if (lhs->memory_precentage != rhs->memory_precentage) {
    return false;
  }
  // memory_total
  ...
  status_interfaces__msg__SystemStatus * output)
{
  ...
  // cpu_precentage
  output->cpu_precentage = input->cpu_precentage;
  // memory_precentage
  output->memory_precentage = input->memory_precentage;
  // memory_total
  output->memory_total = input->memory_total;
  // memory_available
  output->memory_available = input->memory_available;
  // net_send
  output->net_send = input->net_send;
  // net_recv

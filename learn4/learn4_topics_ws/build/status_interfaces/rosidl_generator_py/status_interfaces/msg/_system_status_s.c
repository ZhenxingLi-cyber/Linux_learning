...
bool status_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // cpu_precentage
    PyObject * field = PyObject_GetAttrString(_pymsg, "cpu_precentage");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cpu_precentage = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_precentage
    PyObject * field = PyObject_GetAttrString(_pymsg, "memory_precentage");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->memory_precentage = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_total
  ...
  {  // net_send
    PyObject * field = PyObject_GetAttrString(_pymsg, "net_send");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->net_send = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // net_recv
...
PyObject * status_interfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // cpu_precentage
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cpu_precentage);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cpu_precentage", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // memory_precentage
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->memory_precentage);
    {
      int rc = PyObject_SetAttrString(_pymessage, "memory_precentage", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // net_send
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->net_send);
    {
      int rc = PyObject_SetAttrString(_pymessage, "net_send", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }

...
struct SystemStatus_
{
  ...
  : stamp(_init)
  {
    ...
    {
      this->host_name = "";
      this->cpu_precentage = 0.0f;
      this->memory_precentage = 0.0f;
  ...
  using _cpu_precentage_type =
    float;
  _cpu_precentage_type cpu_precentage;
  using _memory_precentage_type =
    float;
  _memory_precentage_type memory_precentage;
  ...
  using _net_send_type =
    double;
  _net_send_type net_send;
  ...
  Type & set__cpu_precentage(
    const float & _arg)
  {
    this->cpu_precentage = _arg;
    return *this;
  }
  Type & set__memory_precentage(
    const float & _arg)
  {
    this->memory_precentage = _arg;
    return *this;
  }
  ...
  bool operator==(const SystemStatus_ & other) const
  {
    ...
    if (this->cpu_precentage != other.cpu_precentage) {
      return false;
    }
    if (this->memory_precentage != other.memory_precentage) {
      return false;
    }
    ...
    if (this->net_send != other.net_send) {
      return false;
    }

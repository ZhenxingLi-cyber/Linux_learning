...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    _fields_and_field_types = {
        ...
        'host_name': 'string',
        'cpu_precentage': 'float',
        'memory_precentage': 'float',
        'memory_total': 'float',
    ...
    def __init__(self, **kwargs):
        ...
        self.cpu_precentage = kwargs.get('cpu_precentage', float())
        self.memory_precentage = kwargs.get('memory_precentage', float())
        self.memory_total = kwargs.get('memory_total', float())
        self.memory_available = kwargs.get('memory_available', float())
        self.net_send = kwargs.get('net_send', float())
    ...
    def __eq__(self, other):
        ...
        if self.host_name != other.host_name:
            return False
        if self.cpu_precentage != other.cpu_precentage:
            return False
        if self.memory_precentage != other.memory_precentage:
            return False
        if self.memory_total != other.memory_total:
            return False
        if self.memory_available != other.memory_available:
            return False
        if self.net_send != other.net_send:
            return False
    ...
    @builtins.property
    def cpu_precentage(self):
        """Message field 'cpu_precentage'."""
        return self._cpu_precentage

    @cpu_precentage.setter
    def cpu_precentage(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cpu_precentage' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cpu_precentage' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._cpu_precentage = value

    @builtins.property
    def memory_precentage(self):
        """Message field 'memory_precentage'."""
        return self._memory_precentage

    @memory_precentage.setter
    def memory_precentage(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'memory_precentage' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'memory_precentage' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._memory_precentage = value
    ...
    @builtins.property
    def net_send(self):
        """Message field 'net_send'."""
        return self._net_send

    @net_send.setter
    def net_send(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'net_send' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'net_send' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._net_send = value
